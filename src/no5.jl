...
#=!
Julia در کنار فایل ورودی فايل ديگري با نام با پسوند cov (coverage) توليد مينمايد، اين فايل تعداد فراخوان هاي مترادف براي هر خط کد از فايل مرجع را گزارش مينمايد. 
!=#
#=
        - function vectorizeVSdevectorize()
        1     len::Int = 10000
