...
=#
#=!
این بار Julia با شرایط مناسب جهت ثبت مقدار حافظه اختصاص داده شده (memory allocation) حین اجرای هر کدام از خطوط برنامه، فراخوانده میشود. گزارش تولیدی با پسوند mem همنام با فایل اصلی و در کنار آن ذخیره میشود.
!=#
...
بررسی گزارش mem فایل تولید شده (کد بالا) نشان میدهد در حین محاسبه برداری 213023 واحد و غیر برداری 80048 واحد حافظه اختصاص داده میشود.
!=#
